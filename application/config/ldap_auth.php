...
|
*/
$config['ldap_server']= "ldap://10.32.2.8"; //set this to your LDAP server name.
$config['user_prefix']="cug\\"; //if you specify your domain you must escape the backslash '\' with a backslash '\\'
$config['user_suffix'] = NULL;
$config['dc'] = "dc=cug,dc=co,dc=cu";
$config['ds'] = ldap_connect($config['ldap_server']);