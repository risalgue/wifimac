...
<!--<link rel="stylesheet" href="<?php //echo base_url('bootstrap.min.css'); ?>" media="screen" title="no title"> -->
              ...
              <div class="login-panel panel panel-success">
                  ...
                  if($error_msg){
                   ...
                   ?>
                      ...
                      <center><b>Already registered ?</b> <br></b><a href="<?php echo base_url('user'); ?>">Login here</a></center><!--for centered text-->
                  </div>
              </div>
          </div>
      </div>
